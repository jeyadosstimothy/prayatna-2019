                ...
                view: function(){
                    ...
                    return m('div.anim-appear-fadein', [
                        ...
                        m('ul', {class: 'mdc-typography--body1'},
                            ...
                            m('li', 'Paper should not exceed 15 pages and abstract section should not exceed 1 page'),
                        ...
                        m('ul', {class: 'mdc-typography--body1'},
                            ...
                            m('li',
                                ...
                                ', with subject ', m('b', 'Paper Presentation: Prayatna 2019'), '. The mail should contain:'
                            ),
                            m('ul', {class: 'mdc-typography--body1'},
                                m('li', 'Title - Theme of the paper'),
                                m('li', 'Name, Phone and EmailID of Team Members'),
                                m('li', 'Mandatory Attachments - Paper, PPT'),
                                m('li', 'Optional Attachments - Abstract')
                            ),
                            m('li',
                ...
                view: function(){
                    ...
                    return m('div.anim-appear-fadein', [
                        ...
                        m('ul', {class: 'mdc-typography--body1'},
                            m('li',
                                'For any queries contact Karthik: ',
                                m('a', {href: 'tel:+917550105645'}, '7550105645')
                            ),
                        ),
                    ]);
                }
